 ...
 * Describe   : 同步文件上传
 */
public class FileUploadSyncService extends BaseHttpService {
    ...
    private String syncUploadFileToQiNiuYun(File file, String name, String token) {
        try {
            ...
            if (info.isOK()) {
                ...
                e("七牛上传: token: " + token + ", code: " + info.statusCode + ", error: " + info.error);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
