...
public final class CitizenPageRequest extends BasePageRequest {
    ...
    private CitizenPageRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends BasePageRequest.Builder<Builder> {
        ...
        public CitizenPageRequest build() {
            return new CitizenPageRequest(this);
        }
    }
