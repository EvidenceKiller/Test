...
@Getter
public final class ReportStudentMeetRequest extends BaseRequest {
    ...
    private ReportStudentMeetRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends BaseRequest.Builder<Builder> {
        ...
        public ReportStudentMeetRequest build() {
            return new ReportStudentMeetRequest(this);
        }
    }
}