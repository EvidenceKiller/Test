...
@Getter
public final class StudentPageRequest extends BasePageRequest {
    ...
    private StudentPageRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends BasePageRequest.Builder<Builder> {
        ...
        public StudentPageRequest build() {
            return new StudentPageRequest(this);
        }
    }
}